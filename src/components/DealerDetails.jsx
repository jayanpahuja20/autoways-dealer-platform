                        ...
                        <div className="space-y-4">
                            {dealer.aiDealer && (
                                <div className="p-3 bg-white rounded-lg border border-gray-200 shadow-sm flex flex-wrap gap-4 items-center justify-center">
                                    <img src={`${import.meta.env.BASE_URL}HKT.png`} alt="HKT" className="h-10 object-contain" />
                                    <div className="h-8 w-px bg-gray-200"></div>
                                    <img src={`${import.meta.env.BASE_URL}GEM_PWER.png`} alt="GEM POWER" className="h-10 object-contain" />
                                    <div className="h-8 w-px bg-gray-200"></div>
                                    <img src={`${import.meta.env.BASE_URL}GEM_HARNESS.png`} alt="GEM HARNESS" className="h-10 object-contain" />
                                </div>
                            )}
                            ...
                            {dealer.apiDealer && (
                                <div className="p-3 bg-white rounded-lg border border-gray-200 shadow-sm flex justify-center">
                                    <img
                                        src={`${import.meta.env.BASE_URL}GALERIA_LOGO.jpeg`}
