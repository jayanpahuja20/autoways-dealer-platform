        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-8 py-10 text-white">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-blue-100 mt-2">
                        <span className="bg-blue-500/30 px-3 py-1 rounded-full text-sm font-medium border border-blue-400/30">
                            Authorized Dealer
                        </span>
                        {dealer.aiDealer && (
                    ...
                    <div className="mt-4 text-blue-50 flex items-center">
                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
